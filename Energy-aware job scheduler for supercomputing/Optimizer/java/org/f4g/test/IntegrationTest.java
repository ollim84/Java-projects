...
* last modified: $LastChangedDate: 2012-05-02 01:47:35 +0300 (ke, 02 touko 2012) $ by $LastChangedBy: f4g.cnit $
...
public class IntegrationTest extends OptimizerTest {
	...
	public void testHPSLA() {
		...
		ModelGenerator modelGenerator = new ModelGenerator();
		FIT4GreenType model = modelGenerator.getModel("resources" + sep	+ "f4gmodel_instance_ComHP_federated.xml");
		...
		SLAReader sla = new SLAReader("resources" + sep	+ "SLA_instance_ComHP.xml");
