...
* last modified: $LastChangedDate: 2012-04-27 16:03:34 +0300 (pe, 27 huhti 2012) $ by $LastChangedBy: f4g.cnit $
* revision:      $LastChangedRevision: 1384 $
* 
* short description:
...
public class ModelGenerator {
	...
	public static void main(String[] args) {
		...
		test.populateModel("resources/f4gmodel_instance.xml", "f4gmodel_instance_populated.xml");
