...
//		//VMs ressource usage is 0
//		ModelGenerator modelGenerator = new ModelGenerator();
//		modelGenerator.setNB_SERVERS(1000);
//		modelGenerator.setNB_VIRTUAL_MACHINES(2);//4
...
//
//		
//		PolicyType myVmMargins = new PolicyType(new PolicyType.Policy("small", 3, 7, ""));
//
//		
//		OptimizerEngineCloudTraditional myOptimizer = new OptimizerEngineCloudTraditional(new MockController(), new MockPowerCalculator(), new NetworkCost(), 
//				VMs, myVmMargins);
//
//		myOptimizer.setComputingStyle(CloudTradCS.TRADITIONAL);
//		
...
//		
//		PolicyType vmMargins = new PolicyType(new PolicyType.Policy("small", 3, 6, ""));
...
//		//comment here to deactivate sla
//		myOptimizer2.setSlaType(slas);
//		myOptimizer2.setVmTypes(VMs);
//		//TEST 1
//		
//		myOptimizer2.runGlobalOptimization(model);
//		
...
//
//
//		assertEquals(moves.size(), 36);
//		assertEquals(powerOffs.size(), 8);
//
//	}
