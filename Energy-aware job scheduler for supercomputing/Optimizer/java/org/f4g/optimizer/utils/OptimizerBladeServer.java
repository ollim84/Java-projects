...
* 
* short description:
*   optimizer's type to represent a server blade. 
*   
* ============================= /Header ==============================
*/
...
//              public int                     getMaxPower()                                    {	return optimizerServer.getMaxPower(      this);}
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof OptimizerBladeServer) {
        	final OptimizerBladeServer copy = ((OptimizerBladeServer) draftCopy);
    ...
    public Object createNewInstance() {
        return new OptimizerBladeServer();
    }
